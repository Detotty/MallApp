...
@SuppressLint({ "DefaultLocale", "DrawAllocation", "HandlerLeak", "ClickableViewAccessibility" }) public class FastSearchListView extends ListView {
	...
	protected void onDraw(Canvas canvas) {
		...
		Log.e("", "sections.lengt....."+sections.length);
		...
		textPaint.setTextSize(13);//scaledWidth / 2);
		...
		if (showLetter & section != null && !section.equals("")) {
			...
			textPaint2.setTextSize(20);//2 * indWidth);
