...
import com.mallapp.GPS.DirectionsJSONParser;
...
public class MapDirectionActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latlong = getIntent().getStringExtra("latlong").split("-");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng origin = new LatLng(userLocationModel.getLatitude() , userLocationModel.getLongitude() );
        LatLng dest = new LatLng(Double.parseDouble(latlong[0]) , Double.parseDouble(latlong[1]) );
        // mMap.moveCamera(CameraUpdateFactory.newLatLng(origin));
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(new LatLng(userLocationModel.getLatitude() , userLocationModel.getLongitude()))      // Sets the center of the map to location user
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String,String>>> >{
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for(int i=0;i<result.size();i++){
                ...
                lineOptions.width(8);
                lineOptions.color(Color.parseColor("#663399"));
            }
