...
public class SendVerificationCode {
	...
	public static void sendVerificationCode(Context context, String phone_N, boolean push_notification, String countryName, String CountryZipCode) {
		...
		UserProfileModel user_location= new UserProfileModel(countryName, CountryZipCode, phone_N, push_notification);
...
//		phone_N= "+"+phone_N;
		...
		try {
			...
			String url= ApiConstants.SEND_SMS_URL_KEY+phone_N;
...
//		phone_N= "+"+phone_N;
		...
		try {
			...
			String url= ApiConstants.VERIFY_SMS_URL_KEY;
